...
const MODULES = [
  {
    ...
    title: 'לוח בקרה',
    desc: 'מסך הפתיחה האישי. מציג לכל משתמש "מה דורש ממנו פעולה" (תחקורים שצריך למלא, הודעות מנהלים והודעות צ׳אט חדשות, יעדי חלוקה שטרם נמסרו), נתונים מותאמים לתפקיד וקיצורי דרך מהירים.',
  },
  {
    icon: Users,
    title: 'ניהול משפחות',
  ...
  },
  {
    icon: MessagesSquare,
    title: 'צ׳אט',
    desc: 'צ׳אט ארגוני בשני ערוצים: "כללי" לשאלות ושיח של כולם, ו"הודעות חשובות" שבו רק המנכ"ל ובנות השירות יכולים לפרסם (וכולם קוראים). כולל תגובות אימוג׳י, מענה להודעה, עריכה ומחיקה, סימון הודעות שלא נקראו, ועדכון חי.',
  },
  {
    icon: Contact,
    title: 'צוות',
    desc: 'רשימת כל אנשי הצוות — בנות שירות, מדריכים ומתנדבים — עם טלפון, גיל וסניף. כל אחד יכול לערוך את הפרטים שלו; המנכ"ל רואה ועורך את כולם; בת שירות רואה ועורכת את צוות הסניף שלה, ואף יכולה להעביר איש צוות לסניף אחר.',
  },
  {
    icon: ClipboardList,
    title: 'דיווחים ומעקב',
    desc: 'דיווח שעות שבועי — בוחרים שבוע בלוח שנה (שבוע שלם, ראשון עד שבת), רואים אילו שבועות כבר דווחו, ומשייכים שעות לפעילות או ל"כללי" כשאין פעילות. כולל סיכום שבועי ומעקב מי מילא, וייצוא מלא לאקסל (שעות, שבועות ופרטים). בנות שירות ומדריכים חייבים למלא דיווח בכל שבוע (חלון שמופיע אוטומטית עד שהשבוע דווח). כולל ארכיון קבוע של סיכומי חלוקות ותחקורי פעילויות.',
  },
]
...
const ROLES = [
  {
    role: 'מנכ״ל',
    desc: 'גישה מלאה לכל המערכת ולכל הסניפים, כולל שעות מדווחות, צוות מלא (עם עריכת פרטים לכולם ושיוך לסניפים), ועמוד אפיון זה.',
    cls: 'bg-emerald-50 text-emerald-700 border-emerald-100',
  },
  {
    role: 'בת שירות',
    desc: 'ניהול הסניף שלה — משפחות, פעילויות, חלוקות וצוות הסניף (כולל עריכת פרטי הצוות והעברה בין סניפים). חייבת למלא דיווח שבועי.',
