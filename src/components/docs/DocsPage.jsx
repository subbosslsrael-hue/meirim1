...
const MODULES = [
  ...
  },
  {
    icon: ClipboardList,
    title: 'דיווחים ומעקב',
    desc: 'דיווח שעות שבועי לפי פעילות עם סיכום שבועי, ומעקב מי מילא את הדיווח. בנות שירות ומדריכים חייבים למלא דיווח בכל שבוע (חלון שמופיע אוטומטית בכל שבת). כולל ארכיון קבוע של סיכומי חלוקות ותחקורי פעילויות.',
  },
]
